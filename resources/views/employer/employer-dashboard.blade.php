                              ...
                              <td>
                                 <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                       ...
                                       <li>
                                          <form action="{{ route('employe.delete', ['id' => $item->id]) }}"
                                             method="POST">
                                             @csrf
                                             @method('DELETE')
                                             <button type="submit" class="dropdown-item d-flex gap-3"><i
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                       <li><a class="dropdown-item d-flex gap-3"
                                             href="/view/loker-edit/{{ $item->id }}"><i
                                                class="bi bi-eye"></i>Tampilkan</a></li>
                                       <li><a class="dropdown-item text-danger d-flex gap-3" href="#"><i
                                                class="bi bi-trash"></i>Hapus</a></li>
                                    </ul>
                                 </div>
                              </td>
                           </tr>
                     ...
                     <tbody>
                        @foreach ($apply as $item)
                              ...
                              <td>
                                 <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                       ...
                                       @if (empty($item->porto))
                                          <li><a class="dropdown-item text-dark d-flex gap-3" href="#"><i
                                                   class="bi bi-x-lg"></i>No Site</a>
                                          </li>
                                       @else
                                          <li><a class="dropdown-item text-dark d-flex gap-3"
                           ...
                           <div class="modal fade" id="terima{{ $item->id }}" tabindex="-1"
                              ...
                              <form action="{{ route('employe.interview', ['id' => $item->id]) }}" method="POST"
                                       ...
                                       <div class="modal-body">
                                          <div class="mb-1">
                                             <label for="formFile2" class="form-label">Surat
                                                Interview</label>
                                             <input class="form-control" name="surat_interview" type="file"
                                                id="formFile2" style="font-size: 14px">
                                             <input class="form-control" hidden name="status" type="text"
                                                id="formFile2" style="font-size: 14px" value="2">
                                             <input class="form-control" hidden name="loker_id" type="text"
                                                id="formFile2" style="font-size: 14px"
                                                value="{{ $item->loker_id }}">
                                             <input class="form-control" hidden name="employe_id" type="text"
                                                id="formFile2" style="font-size: 14px"
                                                value="{{ $item->employe_id }}">
                                             <input class="form-control" hidden name="apply_id" type="text"
                                                id="formFile2" style="font-size: 14px" value="{{ $item->id }}">
                                             <input class="form-control" hidden name="user_id" type="text"
                                                id="formFile2" style="font-size: 14px" value="{{ $item->user_id }}">
                                          </div>
                                       </div>
                           ...
                           <div class="modal fade" id="tolak{{ $item->id }}" tabindex="-1"
                              aria-labelledby="exampleModalLabel" aria-hidden="true">
                              <form action="{{ route('employe.rejected', ['id' => $item->id]) }}" method="POST">
                                 @csrf
                                 @method('PUT')
                                 <div class="modal-dialog">
                                    <div class="modal-content">
                                       ...
                                       <div class="modal-body">
                                          <div class="mb-1">
                                             ...
                                             <input class="form-control" hidden name="user_id" type="text"
                                                id="formFile2" style="font-size: 14px" value="{{ $item->user_id }}">
                                             <input class="form-control" hidden name="status" type="text"
                                                id="formFile2" style="font-size: 14px" value="1">
                                          </div>
                                       </div>
                                       <div class="modal-footer">
                                          <button type="button" class="btn btn-secondary"
                                    ...
                                    <ul class="dropdown-menu">
                                       <li><a class="dropdown-item d-flex gap-3"
                                             href="/view/loker-edit/kode-loker/kode-candidat"><i
                                                class="bi bi-eye"></i>Show</a></li>
                                       <form action="{{ route('employe.update-candidat', ['id' => $item->id]) }}"
                                          method="POST">
                                          @csrf
                                          @method('PUT')
