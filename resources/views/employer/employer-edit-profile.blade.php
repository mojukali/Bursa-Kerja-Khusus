			...
			<div class="user-profilee">
				<div class="user-avatar">
                              ...
                              <form method="POST" enctype="multipart/form-data">
                                    ...
                                    @method('PUT')
                                    <div class="d-grid">
                                    <div class="btn btn-outline-dark border rounded-pill shadow mt-2" data-bs-toggle="modal" data-bs-target="#photo">
                                          <i class="bi bi-pencil-square"></i>
                                    </div>
                                    </div>
                              </form>
				</div>
				<h5 class="user-name">{{$employe->name}}</h5>
				<h6 class="user-email">{{$employe->email}}</h6>
			</div>
			<div class="about">
				<h5>Deksripsi</h5>
				<p>{{$employe->deskripsi}}</p>
			</div>
		</div>
	</div>
</div>
		...
		<div class="row gutters">
			<form action="{{ route('employe.update-profile', ['id' => $employe->id])}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 d-flex gap-3">
                              ...
                              <div class="btn btn-outline-dark" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">Cancel</div>
                        </div>
                  </form>
		</div>
	</div>
