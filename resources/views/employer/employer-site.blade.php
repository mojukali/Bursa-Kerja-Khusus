      ...
      <div class="card w-50 shadow">
            <form action="{{ route('employe-register')}}" method="POST">
                  ...
                  <div class="card-body px-5">
                        <div class="mb-4">
                              <div class="fw-bolder fs-3 text-center">Sign-Up</div>
                        </div>
                        <div class="mb-3">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                              ...
                              <input type="text" name="name" class="form-control" id="exampleFormControlInput1" placeholder="Masukkan Nama Perusahaan Anda" value="{{old('name')}}">
                        </div>
                        @error('name')
                        <small>{{ $message }}</small>
                        @enderror
                        ...
                        <div class="mb-4">
                              ...
                              <input type="text" name="no_telp" class="form-control" id="inputPassword" placeholder="Masukan Nomor Telepon Perusahaan Anda">
                        </div>
                        @error('no_telp')
                        <small>{{ $message }}</small>
                        @enderror
                        <div class="mb-4">
                              ...
                              <input type="text" name="deskripsi" class="form-control" id="inputPassword" placeholder="Masukan Deksripsi Perusahaan Anda">
                        </div>
                        @error('deskripsi')
                        <small>{{ $message }}</small>
                        @enderror
                        <div class="">
                              <button type="submit" class="btn btn-outline-dark w-100 mb-2 fw-medium ">Daftar</button>
                        </div>
